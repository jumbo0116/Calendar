...
;(function(factory) {
    ...
    EvoCalendar = (function() {
        ...
        function EvoCalendar(element, settings) {
            ...
            _.initials = {
                ...
                dates: {
                    ...
                    tw: {
                        ...
                        noEventForToday: "今天無任何紀錄!",
                        noEventForThisDay: "這天無任何紀錄!",
                        previousYearText: "上一年",
                        nextYearText: "下一年",
                        closeSidebarText: "隱藏選單",
                        closeEventListText: "隱藏列表"
                    }
                }
            }
            _.initials.weekends = {
            ...
            _.$label = {
                ...
                monthsName: _.initials.dates[_.defaults.language].monthsName,
    ...
    EvoCalendar.prototype.formatDate = function (date, format, language) {
        ...
        var val = {
            ...
            MM: _.initials.dates[language].monthsName[ndate.getMonth()],
        ...
        if (!_.$elements.calendarEl.html()) {
            ...
            markup = '<div class="calendar-sidebar">'+
                        ...
                        '<ul class="calendar-months">';
                            for(var i = 0; i < _.$label.monthsName.length; i++) {
                                markup += '<li class="month" role="button" data-month-val="' + i + '">' + _.initials.dates[_.options.language].monthsName[i]+'</li>';
                            }
                        markup += '</ul>';
            markup += '</div></div>';
    ...
    ****************/
    ...
    EvoCalendar.prototype.ClearCalendarEvent = function () {
        // Array index
        _.options.calendarEvents.foreach(function (d) { d.id });
    };
